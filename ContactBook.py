...
def DisplayForm():
    ...
    display_screen.geometry("1020x900")
    ...
    #label for heading
    lbl_text = Label(TopViewForm, text="CONTACT BOOK", font=('verdana', 18), width=600,bg="orange")
    ...
    Label(LFrom, text="Email_Address ", font=("Arial", 12),bg="#15244C",fg="white").pack(side=TOP)
    ...
    lbl_txtsearch = Label(LeftViewForm, text="Enter first_name to Search", bg="white",font=('verdana', 10))#,bg="#0B4670")
    lbl_txtsearch.pack()
    #creating search entry
    search = Entry(LeftViewForm, textvariable=SEARCH, font=('verdana', 10), width=10)
    ...
    tree.heading('Rollno', text="Email_Address", anchor=W)
